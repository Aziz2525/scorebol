...
function sidebar() {
    return (
        <aside className="w-64 border-r-2 border-r-slate-200" aria-label="Sidebar">
            <div className="h-screen overflow-y-auto py-4 px-3 bg-white  rounded dark:bg-gray-800 flex flex-1 flex-col justify-between" >
                <div>
                    <h3 className="text-blue-900 font-bold text-xl ml-2 mb-6 uppercase">Scorebol</h3>
                    <ul className="space-y-2">
                        <li>
                            <a href="#" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <span className="ml-3">Fikstür</span>
                            </a>
                        </li>
                        <li>
                            <a href="#" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <span className="flex-1 ml-3 whitespace-nowrap">Ligler</span>
                        ...
                        <li>
                            <a href="#" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <span className="flex-1 ml-3 whitespace-nowrap">Transferler</span>
                ...
                <div id="dropdown-cta" className="p-4 mt-6 bg-blue-50 rounded-lg dark:bg-blue-900" role="alert">
                    ...
                    <p className="mb-3 text-sm text-blue-900 dark:text-blue-400">
                        Şuanda Skorbol beta sürümündesiniz geliştirmelerimize yardımcı olmak için lütfen bizlere geri dönüşte bulunun.
                    </p>
                    <a className="text-sm text-blue-900 underline hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300" href="#">Geri bildirimde bulun</a>
                </div>
            </div>
        </aside>
    )
